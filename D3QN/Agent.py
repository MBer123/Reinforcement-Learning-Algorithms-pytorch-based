...
class D3QN:
    ...
    def __init__(self, state_dim, action_dim, ckpt_dir, lr=0.0003, fc1_dim=256, fc2_dim=256,
        ...
        self.main_net = ["Q_eval"]  # 主网络的名称

        # 初始化评估网络和目标网络
        self.q_eval = DuelingDeepQNetwork(lr=lr, state_dim=state_dim, action_dim=action_dim,
                                          fc1_dim=fc1_dim, fc2_dim=fc2_dim)
        self.q_target = DuelingDeepQNetwork(lr=lr, state_dim=state_dim, action_dim=action_dim,
                                            fc1_dim=fc1_dim, fc2_dim=fc2_dim)
    ...
    def learn(self):
        ...
        with T.no_grad():
            ...
            target = rewards_tensor + self.gamma * q_[batch_idx, max_actions]  # 计算目标Q值
